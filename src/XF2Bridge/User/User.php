<?php namespace culv3r\XF2Bridge\User;
...
class User implements UserInterface, Authenticatable
{
     ...
     */
    public function addUser($email,$username,$password,array $additional = [], $languageId = XF2Bridge::XENFOROBRIDGE_DEFAULT_LANGUAGE_ID)
    {
        // Verify Password
